...
def parse_args():
    ...
    p.add_argument("--start-domain", type=str, default="gsmu_by")
...
def main():
    ...
    start_domain_visited = False

    for domain_dir in domain_dirs:
        if domain_dir.name != args.start_domain and not start_domain_visited:
            continue
        else:
            start_domain_visited = True
